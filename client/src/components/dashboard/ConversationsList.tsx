    ...
    return (
        <div className="relative group">
            ...
            <div
                ...
                className={cn(
                    "w-full flex items-center gap-3 px-3 py-3 rounded-lg text-left transition-all cursor-pointer mx-2",
                    isActive
                        ? "bg-linear-to-r from-primary/20 to-primary/10 border border-primary/30 shadow-md shadow-primary/10"
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between gap-1 mt-1">
                        ...
                        {unread > 0 && !isTyping && (
                            <span className="shrink-0 flex bg-linear-to-r from-primary to-primary/80 items-center justify-center min-w-5 h-5 rounded-full text-white text-[10px] font-bold px-1 shadow-lg shadow-primary/40">
                                {unread > 99 ? "99+" : unread}
                            </span>
                        )}
                    </div>
