...
<head>
  ...
  <title>New Message on Talkify</title>
</head>
        ...
        <table width="520" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td align="center" style="background-color:#6366f1;padding:32px 40px;">
              <h1 style="margin:0;color:#ffffff;font-size:24px;font-weight:700;letter-spacing:0.5px;">Talkify</h1>
          ...
          <tr>
            <td align="center" style="background-color:#f9fafb;border-top:1px solid #e5e7eb;padding:18px 40px;">
              <p style="margin:0;font-size:12px;color:#9ca3af;">
                You're receiving this because email notifications are enabled on your Talkify account.
              </p>
